...
dataset_examples = [
    {
        "inputs": {
            "conversation": [
                {
                    "turn": 1,
                    "user_input": "I have an exam on calculus tomorrow and I'm really confused about integrals. I thought I understood the concept but now I'm completely blanking. Can you explain it to me intuitively?",
                    "valence": "Slightly Negative",
                },
                {
                    "turn": 2,
                    "user_input": "I see what you're saying but I'm still really stressed about it. I need examples as well because I don't know how to solve a integral problem.",
                    "valence": "Moderately Negative",
                },
                {
                    "turn": 3,
                    "user_input": "I tried following and solving the example myself, but I got the wrong answer. This is so annoying and I'm very stressed out.",
                ...
                {
                    "turn": 9,
                    "user_input": "I also need some help on my psychology assignment. We need to explain the psychology of parenting and how much of a factor the home environment plays in the development of a child compared to the overall environment that they're in outside of their home like school or friends. Can you explain that idea to me, the history behind it, and whether parents play a bigger or smaller role than we thought in the development of a child?",
                    "valence": "Neutral",
                },
                {
                    "turn": 10,
                ...
                {
                    "turn": 14,
                    "user_input": "So that's how that works. That makes a lot of sense really. Thanks for helping me. I feel a lot better about these two topics going into next week.",
                    "valence": "Moderately Positive",
                },
            ]
        },
